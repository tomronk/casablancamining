					...
					<div class="t7_vanski">
											...
											<?php if ($left_ter): ?>				
												<div id="t7_subnav">
													...
													$thirdlvl = $node->field_thirdlevel;
													$number=count($thirdlvl);
													?>
													...
													if (isset($thirdlvl[0]["safe"]["title"])) {
														...
														foreach ($thirdlvl as $mnu) {
															...
															if ($number==1){
															$tnodes .= '<img src="/sites/all/themes/casablancamining/images/nav_prev_off.png" width="38" height="62" alt="previous" />';
															} else {
															...
															if ($number==1) {
															$tnodes .= '<img src="/sites/all/themes/casablancamining/images/nav_next_off.png" width="38" height="62" alt="next" />';
															} else {
...
copies of these filings from the SEC website at http://www.sec.gov/edgar.html.
			...
			<div id="t7_extender"><!-- Test page-nodetype-content --></div>
